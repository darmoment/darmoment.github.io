...
document.getElementById("bottom-nav").style.top = (document.getElementById("particles-js").scrollHeight + document.getElementById("skills").scrollHeight + document.getElementById("projectsec").scrollHeight + document.getElementById("contact").scrollHeight + 250) + "px";